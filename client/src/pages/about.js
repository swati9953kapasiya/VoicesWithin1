    ...
    <div>
        ...
        <div className="abouthead-container">
            <div className="max-width">
                <h1>About <br></br> <span>Voices</span> Within</h1>
          ...
          <div className="max-width">
              <div className="our-values">
                <div className="card-value">
                  ...
                  <p>Think of Voices Within as your lifelong guide to better mental health. We’re here for you whenever you need us, wherever you are, helping you get through tough times and find joy in every day.</p>
                </div>
                <div className="card-value">
                <h1>
                    What we <span>do</span>
                  </h1>
                  <p>Through evidence-based meditation and mindfulness tools, mental health coaching, therapy, psychiatry, Voices Within helps you create life-changing habits to support your mental health and find a healthier, happier you.</p>
                </div>
                <div className="card-value">
                <h1>
